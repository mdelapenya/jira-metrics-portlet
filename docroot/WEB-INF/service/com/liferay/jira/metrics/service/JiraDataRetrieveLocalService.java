...
/**
 * Provides the local service interface for JiraDataRetrieve. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Manuel de la Peña
 * @see JiraDataRetrieveLocalServiceUtil
...
public interface JiraDataRetrieveLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JiraDataRetrieveLocalServiceUtil} to access the jira data retrieve local service. Add custom service methods to {@link com.liferay.jira.metrics.service.impl.JiraDataRetrieveLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
