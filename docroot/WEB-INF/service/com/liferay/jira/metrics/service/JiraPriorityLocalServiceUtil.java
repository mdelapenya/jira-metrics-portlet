...
/**
 * Provides the local service utility for JiraPriority. This utility wraps
 * {@link com.liferay.jira.metrics.service.impl.JiraPriorityLocalServiceImpl} and is the
 ...
 * @generated
 */
public class JiraPriorityLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.jira.metrics.service.impl.JiraPriorityLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.jira.metrics.model.JiraPriority createJiraPriority(
		long jiraPriorityId) {
		return getService().createJiraPriority(jiraPriorityId);
	}
	...
	*/
	...
	public static com.liferay.jira.metrics.model.JiraPriority getJiraPriorityByName(
		...
		throws com.liferay.jira.metrics.NoSuchJiraPriorityException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getJiraPriorityByName(name);
	}

	public static com.liferay.jira.metrics.model.JiraPriority getJiraPriorityByValue(
	...
	public static JiraPriorityLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					JiraPriorityLocalService.class.getName());

			if (invokableLocalService instanceof JiraPriorityLocalService) {
				_service = (JiraPriorityLocalService)invokableLocalService;
			}
			else {
				_service = new JiraPriorityLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(JiraPriorityLocalServiceUtil.class,
				"_service");
		}
	...
	private static JiraPriorityLocalService _service;
}