...
public class JiraComponentModelImpl extends BaseModelImpl<JiraComponent>
	...
	public static final String TABLE_SQL_CREATE = "create table jirametrics_JiraComponent (jiraComponentId LONG not null primary key,createDate DATE null,modifiedDate DATE null,uri VARCHAR(75) null,jiraProjectId LONG,name VARCHAR(75) null,disabled BOOLEAN)";
	...
	public Object clone() {
		...
		jiraComponentImpl.setDisabled(getDisabled());
	...
	public CacheModel<JiraComponent> toCacheModel() {
		...
		jiraComponentCacheModel.disabled = getDisabled();
